...
type (
	...
	RemoveVideoResp = __.RemoveVideoResp
...
func (m *defaultFileService) RemoveVideo(ctx context.Context, in *RemoveVideoReq, opts ...grpc.CallOption) (*RemoveVideoResp, error) {
	client := __.NewFileServiceClient(m.cli.Conn())

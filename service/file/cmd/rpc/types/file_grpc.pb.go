...
func (c *fileServiceClient) RemoveVideo(ctx context.Context, in *RemoveVideoReq, opts ...grpc.CallOption) (*CodeResp, error) {
	out := new(CodeResp)
...
type FileServiceServer interface {
	...
	RemoveVideo(context.Context, *RemoveVideoReq) (*CodeResp, error)
...
func (UnimplementedFileServiceServer) RemoveVideo(context.Context, *RemoveVideoReq) (*CodeResp, error) {

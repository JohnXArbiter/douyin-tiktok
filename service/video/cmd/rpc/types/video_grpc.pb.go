...
func (c *videoServiceClient) SaveVideo(ctx context.Context, in *SaveVideoReq, opts ...grpc.CallOption) (*SaveVideoResp, error) {
...
func (UnimplementedVideoServiceServer) SaveVideo(context.Context, *SaveVideoReq) (*SaveVideoResp, error) {
